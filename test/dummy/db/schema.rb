...
ActiveRecord::Schema[7.0].define(version: 2022_10_12_022334) do
  create_table "complete_completions", force: :cascade do |t|
    ...
    t.string "completor_type", null: false
    t.integer "completor_id", null: false
    t.boolean "completed", default: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["completable_type", "completable_id"], name: "index_complete_completions_on_completable"
    t.index ["completor_type", "completor_id"], name: "index_complete_completions_on_completor"
  end
